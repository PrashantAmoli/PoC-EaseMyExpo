	...
	return (
		<>
			<div className="relative">
				<Modal isOpen={isOpen} setIsOpen={setIsOpen} slot={slot}></Modal>
			</div>
			<div className="hover:bg-red-500/50 hover:scale-105 relative z-50 w-full text-center font-bold">{slot}</div>
					...
					<g>
						...
						<a xlinkHref="#" target="_blank" rel="noopener noreferrer">
							<polygon
								...
								stroke="#FFFFFF"
								stroke-miterlimit="10"
								points="177.271,141.248 177.271,186.248 158.271,186.248
142.561,141.248 		"
							></polygon>
							<text transform="matrix(-6.123234e-017 -1 1 -6.123234e-017 170.8735 176.6855)" fill="#FFFFFF">
								CE1
							</text>
						</a>{' '}
					</g>
...
182.271,266.248 177.271,266.248 177.271,186.248 		"
							></polygon>
							<text transform="matrix(1 0 0 1 201.0234 238.4712)">
								<tspan x="0" y="0" fill="#FFFFFF">
									K
								</tspan>
								<tspan x="8.932" y="0" fill="#FFFFFF">
									G
								</tspan>
							</text>
						</a>{' '}
					...
					<g>
						...
						<a xlinkHref="#" target="_blank" rel="noopener noreferrer">
							...
							<text transform="matrix(1 0 0 1 355.0796 253.0171)">
								<tspan x="0" y="0" fill="#FFFFFF">
									K
								</tspan>
								<tspan x="9.422" y="0" fill="#FFFFFF">
									J
								</tspan>
							</text>
						</a>{' '}
					...
					<g>
						...
						<a xlinkHref="#" target="_blank" rel="noopener noreferrer">
							<polygon
								...
								stroke="#FFFFFF"
								stroke-miterlimit="10"
								points="739.271,223.248 685.512,277.248 685.271,277.248
685.271,186.248 723.631,186.248 717.271,223.248 		"
							></polygon>
							<text transform="matrix(1 0 0 1 692.0176 238.4712)" fill="#FFFFFF">
								KP
							</text>
						</a>{' '}
					</g>
					<g>
						...
						<a xlinkHref="#" target="_blank" rel="noopener noreferrer">
							<polygon
								...
								stroke="#FFFFFF"
								stroke-miterlimit="10"
								points="177.271,186.248 177.271,266.248 161.271,266.248
161.271,247.248 121.271,247.248 121.271,186.248 		"
							></polygon>
							<text transform="matrix(1 0 0 1 139.8384 219.7139)">
								<tspan x="0" y="0" fill="#FFFFFF">
									1
								</tspan>
								<tspan x="6.216" y="0" fill="#FFFFFF">
